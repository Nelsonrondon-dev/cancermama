        ...
        var handleDropzoneFileUpload = {
            ...
            handleSuccess: function (response){
                ...
                $('#nuevo').append(
                    ...
                    <div class="card-body">
                      <a href="`+window.location.origin + '/storage/imagenes/'+ response.imagen1 +`" class="btn btn-primary" download >Descargar ahora</a>
                    </div>
                     </div></div>`);

                     $('#nuevo').append(
                    `<div class="col mb-4"><div class="card">
                    <img src="`+window.location.origin + '/storage/imagenes/' + response.imagen2 +`" class="card-img-top" alt="...">
                    <div class="card-body">
